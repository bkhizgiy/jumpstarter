...
```{code-block} console
curl -fsSL https://raw.githubusercontent.com/jumpstarter/jumpstarter/main/install.sh | sh
```

Or with explicit source specification (main branch example)
```{code-block} console
curl -fsSL https://raw.githubusercontent.com/jumpstarter/jumpstarter/main/install.sh | sh -s -- -s main
```
